...
https://github.com/astra-sh/qvr_playground.git  code-review        v0.2.0
...
`
	...
	want := []manifest.Entry{
		{RepoURL: "https://github.com/astra-sh/qvr_playground.git", Skill: "code-review", Version: "v0.2.0", Line: 2},
...
func TestParse_AllFlags(t *testing.T) {
	in := `https://github.com/astra-sh/qvr_playground.git  code-review  v0.2.0  --commit=94e539be7d6a01774d723a7c25513af0f070de7b  --target=claude,cursor  --as=cr-v2  --registry-alias=raks
`
	got, perrs, err := manifest.Parse(strings.NewReader(in))
	if err != nil {
		t.Fatalf("Parse: %v", err)
...
func TestFormat_RoundTrip(t *testing.T) {
	entries := []manifest.Entry{
		{RepoURL: "https://github.com/astra-sh/qvr_playground.git", Skill: "code-review", Version: "v0.2.0"},
